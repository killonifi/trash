...
class TwoSwitchFlybackDesign:
    # --- входные данные ---
    V_in_min: float      # минимальное входное, В
    V_in_max: float      # максимальное входное, В
    V_out: float         # выходное, В (один канал)
    P_out: float         # мощность, Вт
    f_sw: float          # частота, Гц
